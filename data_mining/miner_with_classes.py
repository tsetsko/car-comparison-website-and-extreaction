...
class CarModels:
    def __init__(self):
        self.car_models_list = list(pd.read_excel('car_brands_and_models_links_Skoda.xlsx').itertuples(index=False, name=None))
...
df2.to_excel(f"data_{TODAYS_DATE}_Skoda.xlsx")
