...
URL = "https://www.mobile.bg/pcgi/mobile.cgi?act=3&slink=p8fhkh&f1"
...
def generate_text_from_html(url_for_conversion):
    response = requests.get(url_for_conversion, headers=HEADER)
    soup = BeautifulSoup(response, "html.parser")
    return soup

print(generate_text_from_html(URL))
...
#     all_cars = []
#     html_parsed = generate_text_from_html(pages_with_cars)
